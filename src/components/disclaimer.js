...
function Disclaimer() {
    return (
        <div className='disclaimer-container'>
            <h3>Disclaimer</h3>
            <p>The information provided on this website is intended for general informational purposes only and should not be considered as medical advice, diagnosis, or treatment. While we strive to ensure the accuracy and reliability of the information presented, we make no guarantees or warranties regarding its completeness, accuracy, or timeliness. The content on this site is not intended to replace professional medical consultation, diagnosis, or treatment. Always seek the advice of your physician or other qualified healthcare provider with any questions you may have regarding a medical condition. Never disregard professional medical advice or delay in seeking it because of something you have read on this website.</p>
            <p>If you think you may have a medical emergency, call your doctor or emergency services immediately. Reliance on any information provided by this website is solely at your own risk. We do not endorse any specific tests, physicians, products, procedures, opinions, or other information that may be mentioned on the website.</p>
